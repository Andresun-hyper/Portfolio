...
const projects: Project[] = [
  {
    id: 1,
    title: '宠物水杯',
    titleEn: 'DROPLET Pet Hydration Bottle',
    category: '宠物出行产品',
    categoryEn: 'Pet Outdoor Product',
    summary: '一体化便携饮水、营养补给与握持体验设计。',
    summaryEn: 'A Red Dot Award: Design Concept Winner 2026 portable pet water bottle with integrated flow, supplement, and grip experience.',
    desc: '围绕户外遛宠场景设计，强调单手开合、可控出水、营养补给和透明水路可视化，用更轻松的材料语言建立宠物陪伴体验。',
    descEn: 'A portable hydration product built around one-handed control, visible flow, supplement use, and a warm translucent material language.',
    cover: './droplet-source-render-red-dot-2026.png',
    tags: ['RED_DOT_2026', 'PETCARE', 'INDUSTRIAL', 'FLOW_DESIGN'],
    floor: 'ROOF_15',
    accent: '#FDB933',
    gallery: [
